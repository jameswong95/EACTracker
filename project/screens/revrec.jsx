/* revrec.jsx — Revenue Recognition
   Single recognition method (input method) — applies to all projects.
   PMs never see/choose a method; it works behind the scenes.
   This file covers: the internal explainer, the upfront plan, the monthly
   guardrail, and the PD over-recognition risk view. */

const monthsRR = ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];

/* ──────────────────────────────────────────────────────────────────
   A · Concept primer — output vs input method side-by-side narrative
   ────────────────────────────────────────────────────────────────── */
const RevRecConcept = () => (
...
/* ──────────────────────────────────────────────────────────────────
   B · Initial recognition plan (upfront phasing — year × quarter)
   ────────────────────────────────────────────────────────────────── */
const RevRecPlan = () => (
    ...
    <div className="row full" style={{alignItems:'stretch'}}>
      ...
      <div className="col grow">
        ...
        <div className="p-4 col gap-3 grow" style={{overflow:'hidden'}}>
          ...
          {/* Cumulative line + cost expectation */}
          <div className="row gap-3 grow">
            <div className="box p-3 col gap-2 grow">
              ...
              <svg width="100%" height="160" viewBox="0 0 560 160" preserveAspectRatio="none">
                ...
                {/* planned revenue — concave-down through Y1, gentler after */}
                ...
                {/* expected cost — close but slightly under */}
...
/* ──────────────────────────────────────────────────────────────────
   C · Monthly recognition view with over-recognition guardrail
   ────────────────────────────────────────────────────────────────── */
const RevRecMonthly = () => (
  <div className="wf pov-only pov-pm">
    <SVGFilters/>
    <div className="row full" style={{alignItems:'stretch'}}>
      ...
      <div className="p-4 col gap-3 grow">
        ...
        {/* This-month summary strip — sums of the per-sub-job inputs below */}
        <div className="row gap-3">
        ...
        {/* Per sub-job input grid — the PM enters cost + margin each month */}
        <div className="box p-3 col gap-2">
          <div className="row">
        ...
        {/* The guardrail panel — plan vs actual */}
        <div className="row gap-3">
          <div className="box p-3 col gap-2 grow">
            <div className="row">
...
/* ──────────────────────────────────────────────────────────────────
   D · Over-run risk — what happens if EAC drifts and you don't refresh
   ────────────────────────────────────────────────────────────────── */
const RevRecRisk = () => (
...
Object.assign(window, { RevRecConcept, RevRecPlan, RevRecMonthly, RevRecRisk });
