/* flows.jsx — End-to-end user flow storyboards
   Each flow renders as a row of mini-frames + arrows + captions. */

// Tiny phone-screen-ish wireframe slots
    ...
    <div className="p-5 col gap-4 full">
      ...
      <div className="row gap-3" style={{alignItems:'stretch',padding:'24px 0 14px'}}>
        <MiniFrame n="1" cap="Open dashboard">
          ...
          <MiniRow><span className="dot ok"></span>EAC Refresh · 5 May</MiniRow>
          <MiniRow hi="warn"><span className="dot warn"></span>Network Mod · UPDATE DUE</MiniRow>
          <MiniRow><span className="dot ok"></span>Asset Refresh · 9 May</MiniRow>
          <div className="grow"/>
        ...
        <MiniFrame n="3" cap="AI streams output" hi="hi">
        ...
        <MiniFrame n="5" cap="Done · 8m elapsed">
          ...
          <MiniRow hi="ok"><span className="dot ok"></span>EAC Refresh · 5 May</MiniRow>
          <MiniRow hi="ok"><span className="dot warn"></span>Network Mod · just now</MiniRow>
          <MiniRow><span className="dot ok"></span>Asset Refresh · 9 May</MiniRow>
          <div className="grow"/>
  ...
  <div className="wf flow">
    ...
    <div className="p-5 col gap-4 full">
      ...
      <div className="row gap-3" style={{alignItems:'stretch',padding:'24px 0 14px'}}>
        ...
        <MiniFrame n="4" cap="Resolve unmapped" hi="hi">
    ...
    <div className="p-5 col gap-4 full">
      ...
      <div className="row gap-3" style={{alignItems:'stretch',padding:'24px 0 14px'}}>
        <MiniFrame n="1" cap="Portfolio · team">
          ...
          <MiniRow hi="bad"><span className="dot bad"></span>Site Comm Ph2 · +7.7%</MiniRow>
          <MiniRow hi="warn"><span className="dot warn"></span>Network Mod · +2.2%</MiniRow>
          <MiniRow><span className="dot ok"></span>EAC Refresh · +1.2%</MiniRow>
          <MiniRow><span className="dot ok"></span>Asset Refresh · -0.5%</MiniRow>
          <div className="grow"/>
        ...
        <MiniFrame n="3" cap="Read trend" hi="hi">
...
Object.assign(window, { FlowPmMonthly, FlowFinanceImport, FlowPdReview });
