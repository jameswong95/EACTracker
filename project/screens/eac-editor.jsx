/* eac-editor.jsx — EAC Editor / Time-phased view variations */

const months = ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];

const TimeCell = ({past, value, hi, override, blank}) => (
  <div className="td" style={{
    background: past?'var(--paper-3)':'var(--paper)',
    color: past?'var(--ink-3)':'var(--ink)',
    fontVariantNumeric:'tabular-nums',
    justifyContent:'flex-end',
    border: hi?'1.5px dashed var(--info)':undefined,
      ...
      <div className="col grow">
        ...
        <div className="p-4 col gap-3 grow" style={{overflow:'hidden'}}>
          ...
          <div className="box p-3 col gap-2 grow" style={{overflow:'hidden'}}>
            ...
            <Table
              cols={['Row',...months,'Total']}
              colWidths={`1.6fr ${months.map(()=>'.6fr').join(' ')} .9fr`}
              rows={[
                ...
                const cells = r.map((c,ci)=>{
                  if(ci===0) return c;
                  if(ci===13) return <span className="b">{c}</span>;
                  const past = ci<=4;
                  return (
                    <span style={{
                ...
                cells.__rowStyle = ri===4?{background:'var(--paper-2)',fontWeight:700}:{};
                return cells;
              })}
            />
      ...
      <div className="p-4 col gap-3 grow">
        ...
        <div className="box p-3 col gap-2">
          ...
          <svg width="700" height="160" style={{display:'block'}}>
            ...
            {/* hover ring on a forecast point */}
  ...
  <div className="wf pov-only pov-pm">
    ...
    <div className="col full">
      ...
      <div className="row grow" style={{alignItems:'stretch'}}>
        ...
        {/* Main: time-phased + sparkline for one category */}
...
Object.assign(window, { EacA, EacB, EacC });
