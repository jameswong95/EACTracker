/* assists.jsx — PM operations assists
   - Local-LLM-assisted monthly update drafter (template + guardrails)
   - Excel / WBS importer to ingest legacy WBS sheets into the standardised sub-jobs
*/

/* ──────────────────────────────────────────────────────────────────
   A · AI-assisted monthly update drafter — local model on desktop
   ────────────────────────────────────────────────────────────────── */
const AiUpdate = () => (
...
/* ──────────────────────────────────────────────────────────────────
   B · Excel WBS importer — reconcile a legacy Excel WBS into the
   project's SAP-created sub-job hierarchy (used for migration / one-offs
   where the WBS line isn't yet present in the SAP feed).
   ────────────────────────────────────────────────────────────────── */
const WbsImport = () => (
      ...
      <div className="col grow">
        ...
        <div className="p-4 col gap-3 grow">
          ...
          <div className="row gap-3 grow" style={{alignItems:'stretch'}}>
            ...
            {/* Target — project's own sub-jobs (from SAP) */}
            <div className="box p-3 col gap-2 grow">
              <div className="row">
...
Object.assign(window, { AiUpdate, WbsImport });
