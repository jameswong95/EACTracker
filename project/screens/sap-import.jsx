/* sap-import.jsx — SAP Data Import (Finance)
   New model (per boss · 21 May):
   - SAP is the source. Upload auto-creates Project + WBS hierarchy + Contract Value.
   - WBS is hierarchical: Main WBS e.g. 123456789/001-1, sub-jobs e.g. 123456789/001-1-1.
   - From SAP: Contract Value, Budget per sub-job.
   - Calculated here: Actual CTD, Committed CTD, ETC, EAC, Budget Remaining.
   - Same template every month → confirms / locks prior month's EAC.
*/
...
<div className="wf pov-only pov-fin">
    ...
    <div className="row full" style={{ alignItems: 'stretch' }}>
      ...
      <div className="col grow p-5 gap-4">
        ...
        {/* Recent imports — same shape every month */}
    ...
    <div className="row full" style={{ alignItems: 'stretch' }}>
      ...
      <div className="p-4 col gap-3 grow">
        ...
        <div className="row gap-3 grow" style={{ alignItems: 'stretch' }}>
          {/* Left — confirmation list per project */}
          <div className="box p-3 col gap-2 grow">
            <div className="row">
          ...
          {/* Right — what "lock" means + escalation */}
...
Object.assign(window, { SapA, SapB, SapC });