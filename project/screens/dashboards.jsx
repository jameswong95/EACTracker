/* dashboards.jsx — Role landing pages + secondary list screens
   These are the screens users actually arrive at after login.
   - PMDashboard       PM's home / inbox
   - PMUpdatesList     PM's history of monthly updates
   - PDApprovals       PD's queue of things needing sign-off
   - PDUpdatesFeed     PD's read-feed of recent PM updates
*/
    ...
    <div className="row full" style={{alignItems:'stretch'}}>
      ...
      <div className="col grow">
        ...
        <div className="p-4 col gap-3 grow">
          {/* Hero greeting + this-month strip */}
        ...
        <div className="p-4 col gap-3 grow">
          ...
          <div className="box p-3 col gap-2 grow">
            ...
            <Table
              ...
              rows={[
                ['May ’26', 'EAC Refresh Programme', '— draft', '—',                <span style={{color:'var(--warn)'}}>+3.3%</span>, <span className="pill tiny">draft</span>],
                ['Apr ’26', 'EAC Refresh Programme', '5 May',   'K. Rajah · 7 May', <span style={{color:'var(--warn)'}}>+2.8%</span>, <Status status="ok">approved</Status>],
                ['Apr ’26', 'Wave 3 Cabling',        '5 May',   'K. Rajah · 6 May', 'on plan',                                       <Status status="ok">approved</Status>],
                ['Apr ’26', 'DLP — Tower B',         '4 May',   'K. Rajah · 5 May', 'on plan',                                       <Status status="ok">approved</Status>],
                ['Mar ’26', 'EAC Refresh Programme', '4 Apr',   'K. Rajah · 8 Apr', <span style={{color:'var(--warn)'}}>+1.8%</span>, <Status status="warn">queried · resolved</Status>],
              ]}
            />
          </div>
        </div>
    ...
    <div className="row full" style={{alignItems:'stretch'}}>
      ...
      <div className="col grow">
        ...
        <div className="row grow" style={{alignItems:'stretch'}}>
          ...
          <div className="col gap-2 p-3" style={{flex:'0 0 280px',borderRight:'1.5px solid var(--ink-3)',background:'var(--paper-2)'}}>
            ...
            {[
              ...
              <div key={i} className="box p-3 col gap-1" style={{
                background:q.active?'var(--paper)':'transparent',
                borderColor:q.active?'var(--ink)':'var(--ink-3)',
              }}>
                <div className="row">
          ...
          {/* Right: detail of active request */}
          <div className="col grow p-4 gap-3">
            ...
            <div className="box p-3 col gap-2">
              ...
              <div className="t-sm" style={{fontStyle:'italic',color:'var(--ink-2)'}}>
                "Network swap completed early but vendor lead-time on quality test rig pushed
                hardware into May. EAC drift now $40K — recommend baseline reset so future
                recognition curve stays achievable. All other sub-jobs unchanged."
              </div>
        ...
        <div className="p-4 row gap-3 grow" style={{alignItems:'stretch'}}>
          ...
          <div className="box p-3 col gap-2" style={{flex:'1.4'}}>
            ...
            {[
              ...
              {pm:'A. Lee',     proj:'Site Comms Refresh',     when:'15 May',  drift:'+1.2%', tone:'ok'},
          ...
          {/* Right: preview of selected update */}
          <div className="box p-3 col gap-2 grow">
            <div className="row">
            ...
            <div className="col gap-2 t-sm">
              <div>
                ...
                <div>Wave 1 closed on plan. Quality test rig at 2 of 5 units delivered; vendor confirms remaining 3 by 20 May.</div>
              </div>
              <div>
                <div className="t-xs tt-up">Schedule</div>
                <div>On plan overall. Wave 2 kickoff slips one week pending headcount confirmation.</div>
              </div>
              <div>
                <div className="t-xs tt-up">Cost / EAC</div>
                <div>EAC $1.24M, +3.3% vs $1.20M budget. Mar server slippage absorbed $8K expedite. Recognition tracking $77K ahead — guardrail flagged.</div>
              </div>
              <div>
                <div className="t-xs tt-up">Risks</div>
                <div>Vendor lead-time remains tight; dual-source contract in progress.</div>
              </div>
            </div>
          </div>
        </div>
...
Object.assign(window, { PMDashboard, PMUpdatesList, PDApprovals, PDUpdatesFeed });
